...
const array = ['name entha','Helo','King','Kooi','Love','Thamasha','big fan','charlie','gd n8','kar98','love u','noob','perfect ok','power','saji','sed','single','uyir','thug','avastha','bgm id','moodesh','sketch','Cr7','Cr7 back','Suiii','Portugal','Haters','ayn']
array.map( async (a) => {
